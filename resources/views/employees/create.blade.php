        ...
        <form method="POST" action="{{ route('employees.store') }}">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <textarea name="address" class="form-control @error('address') is-invalid @enderror" rows="1" required>{{ old('address') }}</textarea>
            ...
            <div class="row mb-3">
                <div class="col-md-3">
                    ...
                    <input type="text" name="sss_number" class="form-control" value="{{ old('sss_number') }}">
                </div>
                <div class="col-md-3">
                    <label class="form-label">PhilHealth Number</label>
                    <input type="text" name="philhealth_number" class="form-control" value="{{ old('philhealth_number') }}">
                </div>
                <div class="col-md-3">
                    <label class="form-label">Pag-IBIG Number</label>
                    <input type="text" name="pagibig_number" class="form-control" value="{{ old('pagibig_number') }}">
                </div>
                <div class="col-md-3">
            ...
            <hr class="my-4">
            <h5 class="mb-3 text-primary">Login Credentials</h5>
            ...
            <div class="row mb-4">
                <div class="col-md-6">
                    ...
                    <div class="form-text">Employee will use this password to login.</div>
                </div>
                <div class="col-md-6">
